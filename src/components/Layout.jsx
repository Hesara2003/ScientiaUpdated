  ...
  const navCategories = [
    ...
    },
    {
      ...
      items: [
        ...
        { path: '/classes', label: 'Classes', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
        { path: '/fees', label: 'Fees', icon: 'M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z' },
      ]
    },
    {
      name: "Academics",
      items: [
        ...
        { path: '/tutors', label: 'Tutors', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
      ]
    }
  ];
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-gray-50">
      ...
      >
        ...
        <div className="absolute top-0 right-0 w-1/2 h-1/3 bg-gradient-to-br from-blue-100/20 to-indigo-200/20 rounded-bl-full" />
        <div className="absolute bottom-0 left-0 w-1/2 h-1/3 bg-gradient-to-tr from-purple-100/20 to-indigo-200/20 rounded-tr-full" />
              ...
              <nav className="mt-2 px-3 relative z-10">
                ...
                <div className="mt-8 px-4 pb-6 pt-6 border-t border-gray-100">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <div className="text-sm font-medium text-gray-700">Admin User</div>
                      <button className="text-xs text-blue-600 hover:text-blue-800">Sign out</button>
                    </div>
                  </div>
      ...
      {/* Main Content */}
      <div className={`flex flex-col flex-1 overflow-y-auto transition-all duration-300 ${collapsed ? 'md:ml-20' : 'md:ml-64'}`}>
        <motion.main 
          className="flex-grow p-4 md:p-0 pt-20 md:pt-6 max-w-7xl mx-auto w-full"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.5 }}
